...
## <a name="team_information" /> Team Information

>[!WARNING]
> This section is not part of the original README.md file. This includes extra information on the organization of the repository.
We will be using Git for version control and hosting the repository on GitHub. The `main` branch will be the code submitted with the lab report. Please use another branch for testing, and merge to `main` when everything works correctly.

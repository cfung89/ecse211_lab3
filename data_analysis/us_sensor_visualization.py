...
US_SENSOR_DATA_FILE = "us_sensor_10.csv"
DELAY_SEC = 0.01
...
# print statistics on ultrasonic distance data
print(f"Minimum value: {min(distances)}")
print(f"Maximum value: {max(distances)}")
print(f"Mean: {mean(distances)}")
print(f"Std: {stdev(distances)}")
...
# print statistics on RGB data
print(f"Mean of normalized R values: {mean(red)}")
print(f"Std of normalized R values: {stdev(red)}")
print(f"Mean of normalized G values: {mean(green)}")
print(f"Std of normalized G values: {stdev(green)}")
print(f"Mean of normalized B values: {mean(blue)}")
print(f"Std of normalized B values: {stdev(blue)}")